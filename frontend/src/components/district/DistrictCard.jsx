      ...
      >
        ...
        <div className="absolute bottom-0 inset-x-0 p-5">
          <div className="flex items-end justify-between">
            ...
            {/* Arrow button — flipped in RTL */}
            <div
              className={`bg-primary-500 group-hover:bg-primary-400 text-white rounded-xl p-2.5 transition-all duration-300 group-hover:shadow-glow-orange opacity-0 group-hover:opacity-100 ${
                isRTL
